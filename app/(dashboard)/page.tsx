...
export default function Page() {
  ...
  return (
    <div className="max-w-6xl mx-auto w-full space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* Hero Section */}
      <div className="relative p-5 bg-blue-600 rounded-[2.5rem] shadow-2xl shadow-blue-600/20">
        <h1 className="text-2xl font-black text-white mb-2 leading-tight">O que vamos aprender hoje, Admin?</h1>
        <p className="text-blue-100/80 text-lg">Seu assistente está pronto para analisar seu acervo e sugerir o melhor caminho.</p>
      </div>

      {/* Chat & History Grid */}
      <div className="grid lg:grid-cols gap-8 items-start">
        {/* Chat - 7 Colunas */}
        <section className="lg:col-span-8 flex flex-col gap-4">
          <div className="bg-white border border-slate-200 rounded-[2rem] h-[550px] overflow-hidden shadow-xl">
            <ChatInterface />
          </div>
        </section>
      </div>
